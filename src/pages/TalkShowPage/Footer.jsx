      ...
      <div className="max-w-[1440px] mx-auto relative z-10 px-4 sm:px-6 md:px-8 py-9">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-3">
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="font-medium text-white text-sm">
                2nd Floor, Kanaka Towers, <br />
                Opp to Arcolab, Near Dalmia <br />
                Circle, JP Nagar Phase 4 <br />
                Bengaluru - 560078
              </div>
            </div>
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-5 flex flex-col md:flex-row gap-8">
            ...
            {/* App Download + Social Column */}
            <div className="flex-1 flex flex-col items-start gap-4">
              {/* App Download Buttons */}
              <div className="flex flex-col gap-3 w-full">
                <a
                  href="https://play.google.com/store/apps/details?id=co.april2019.kvr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full"
                >
                  <Button className="w-full max-w-[240px] h-[41px] rounded-[20px] bg-[linear-gradient(90deg,rgba(255,255,255,1)_0%,rgba(153,153,153,1)_100%)] hover:opacity-90 shadow-[0px_4px_4px_#00000040] flex items-center justify-center">
                    <img
                      className="w-[18px] h-[21px] mr-2"
                      alt="Android"
                      src="https://c.animaapp.com/mfm52zfyrgtMVA/img/group-215.png"
                    />
                ...
                >
                  <Button className="w-full max-w-[240px] h-[41px] rounded-[20px] bg-[linear-gradient(90deg,rgba(255,255,255,1)_0%,rgba(153,153,153,1)_100%)] hover:opacity-90 shadow-[0px_4px_4px_#00000040] flex items-center justify-center">
                    <img
                      ...
                      alt="iOS"
                      src="https://c.animaapp.com/mfm52zfyrgtMVA/img/group-218.png"
                    />
                    <span className="font-medium text-black text-base">
                      Get the iOS App
                    </span>
              ...
              <div className="mt-6 w-full">
               ...
               {/* Arattai */}
                ...
                >
                  <img
                    src="images/logo2.0.png" // Replace with your actual image path
                    alt="Arattai Icon"
        ...
        <div className="mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="font-medium text-white text-sm text-center sm:text-left">
            2019-25 © KVR Infinity - www.kvrinfinity.in
          </div>
